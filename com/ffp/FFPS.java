...
public class FFPS<E, V> extends AbstractMap<E, V> implements ConcurrentMap<E,V> {
    ...
    private static int MAX_NODES_PER_BUCKET = 2;
    private static int N_BITS = 3;
    ...
    static {
        ...
        try {
            ...
            HN_addr = unsafe.objectFieldOffset
                    (FFPS.class.getDeclaredField("HN"));
